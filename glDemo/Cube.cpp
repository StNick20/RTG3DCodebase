...
static float colourArray[] = {
	...
	//top 
	1.0f, 0.0f, 0.0f, 1.0f,	//top front left
	1.0f, 0.0f, 0.0f, 1.0f, //top back left 
	1.0f, 0.0f, 0.0f, 1.0f,	//top front right
	1.0f, 0.0f, 0.0f, 1.0f,	//top back right
	 
	//bottom
	0.0f, 0.0f, 1.0f, 1.0f,	//bottom front left
	0.0f, 0.0f, 1.0f, 1.0f,	//bottom back left 
	0.0f, 0.0f, 1.0f, 1.0f,	//bottom front right
	0.0f, 0.0f, 1.0f, 1.0f,	//bottom back right 

	//right
	0.0f, 1.0f, 0.0f, 1.0f,	//top front right
	0.0f, 1.0f, 0.0f, 1.0f, //top back right 
	0.0f, 1.0f, 0.0f, 1.0f,	//bottom front right
	0.0f, 1.0f, 0.0f, 1.0f,	//bottom back right 

	//left
	0.0f, 1.0f, 1.0f, 1.0f,	//top front left
	0.0f, 1.0f, 1.0f, 1.0f,	//top back left  
	0.0f, 1.0f, 1.0f, 1.0f,	//bottom front left
	0.0f, 1.0f, 1.0f, 1.0f,	//bottom back left 

	//front
	1.0f, 1.0f, 0.0f, 1.0f,	//top front left 
	1.0f, 1.0f, 0.0f, 1.0f,	//top front right 
	1.0f, 1.0f, 0.0f, 1.0f,	//bottom front left
	1.0f, 1.0f, 0.0f, 1.0f,	//bottom front right

	//back
	1.0f, 0.0f, 1.0f, 1.0f,	//top back left
	1.0f, 0.0f, 1.0f, 1.0f,	//top back right
	1.0f, 0.0f, 1.0f, 1.0f,	//bottom back left 
	1.0f, 0.0f, 1.0f, 1.0f,	//bottom back right 
};
